...
def player_numbers(teamname)
  arr = []
  game_hash.each do |location, team_data|
    if game_hash[location][:team_name] == teamname
      game_hash[location][:players].each do |player, attributes|
        arr << attributes[:number]
      end
    end
  end
  return arr
...
def player_stats(player)
  game_hash.each do |location, team_data|
      game_hash[location][:players].each do |playername, attributes|
